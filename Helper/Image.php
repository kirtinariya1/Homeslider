 ...
 */
namespace Ktpl\Homeslider\Helper;
...
class Image extends AbstractHelper
{
     ...
     * Current model
     *
     * @var \Ktpl\Homeslider\Model\Product\Image
     */
    protected $_model;
     ...
     * Current Product
     *
     * @var \Ktpl\Homeslider\Model\Product
     */
    protected $_product;
     ...
     *
     * @var \Ktpl\Homeslider\Model\Product\ImageFactory
     */
     ...
     * @param \Ktpl\Homeslider\Model\Product\ImageFactory $productImageFactory
     * @param \Magento\Framework\View\Asset\Repository $assetRepo
     * @param \Magento\Framework\View\ConfigInterface $viewConfig
     */
    public function __construct(
        \Magento\Framework\App\Helper\Context $context,
        \Ktpl\Homeslider\Model\Product\ImageFactory $productImageFactory,
     ...
     *
     * @param \Ktpl\Homeslider\Model\Product $product
    ...
    public function init($product, $imageId, $attributes = [])
    {
        ...
        $this->attributes = array_merge(
            $this->getConfigView()->getMediaAttributes('Ktpl_Homeslider', self::MEDIA_TYPE_CONFIG_NODE, $imageId),
            $attributes
        );
     ...
     *
     * @see \Ktpl\Homeslider\Model\Product\Image
     * @param int $width
     * @param int $height
     * @return $this
     */
    ...
    {
        if ($placeholder) {
            $placeholderFullPath = 'Ktpl_Homeslider::images/product/placeholder/' . $placeholder . '.jpg';
        } else {
            $placeholderFullPath = $this->_placeholder
                ?: 'Ktpl_Homeslider::images/product/placeholder/' . $this->_getModel()->getDestinationSubdir() . '.jpg';
        }
     ...
     *
     * @return \Ktpl\Homeslider\Model\Product\Image
     */
     ...
     * Get current Product
     *
     * @return \Ktpl\Homeslider\Model\Product
     */
    ...
    public function getFrame()
    {
        ...
        if (empty($frame)) {
            $frame = $this->getConfigView()->getVarValue('Ktpl_Homeslider', 'product_image_white_borders');
        }
        return $frame;
    }
